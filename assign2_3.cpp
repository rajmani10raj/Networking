...
int main()
{
    ...
    cin>>n;
    cout<<"Enter packet sending rate of each source ";
    double packet_sending_rate_s1,packet_sending_rate_s2,packet_sending_rate_s3;
    cin>>packet_sending_rate_s1>>packet_sending_rate_s2>>packet_sending_rate_s3;
...
{
    double f=doubleRand();
    double delta_time = -log(f)/packet_sending_rate_s1;
    buffer1.push_back(make_pair(f,make_pair(0,1)));

    f=doubleRand();
    delta_time = -log(f)/packet_sending_rate_s2;
    buffer2.push_back(make_pair(f,make_pair(0,1)));
     f=doubleRand();
    delta_time = -log(f)/packet_sending_rate_s3;
...
*/
    ...
    cin >>time_to_reach_sink;
        ...
        double t_time;
    int r=0,s=1;
    for(int i=0;i<time_of_simulation*(packet_sending_rate_s1+packet_sending_rate_s2+packet_sending_rate_s3);i++)
    {
        for(int j=0;j<n;j++)
        {
...
*/   
     double total_packet_generated=time_of_simulation*(packet_sending_rate_s1+packet_sending_rate_s2+packet_sending_rate_s3);
     double packet_lost = time_of_simulation*(packet_sending_rate_s1+packet_sending_rate_s2+packet_sending_rate_s3)-k;
     cout<<"packet lost "<<packet_lost<<endl;
     double packet_loss_rate = ((time_of_simulation*(packet_sending_rate_s1+packet_sending_rate_s2+packet_sending_rate_s3))-k)/total_packet_generated;
      cout<<"packet lost rate "<<packet_loss_rate<<endl;
